...
export const Signup = () => {
  ...
  const loginwithgoogle = () => {
    window.open("http://localhost:8000/auth/google?signup=yess", "_self");
  };
  // useEffect(() => {
            ...
            <div className={`col-md-6 ${mycss11.aaa} `}>
              <form onSubmit={handlesubmit}>
                <div className={`mb-1`}>
                  ...
                  <input
                    type="text"
                    className={`form-control  ${mycss11.aaan} `}
                ...
                <div className={`mb-1 d-flex`}>
                  <div className={`col centre`}>
                    <button
                      type="submit"
                      className={`btn btn-outline-info text-light fs-5 m1-3 mt-2 me-3`}
                    >
                      Submit
                    </button>
                    <div className="centre me-3 mt-2 text-light fs-4">OR</div>
                    <div
              ...
              <div className={`text-center`}>
                ...
                <h2 className={`text-center fs-5 ${mycss11.txt} `}>
                  Already have an account?
                </h2>
                <Link to="/signin">
                  <button
                    type="button"
                    className={`fs-4 btn btn-link text-light  link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover ch`}
                  >
                    Sign in
                  </button>
                </Link>
